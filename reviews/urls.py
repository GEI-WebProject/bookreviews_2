...
urlpatterns = [
    ...
    path('books/<int:book_id>/reviews/<int:pk>/edit', BookReviewsUpdateView.as_view(), name="review_update"),
    path('books/<int:book_id>/reviews/<int:pk>/delete', BookReviewsDeleteView.as_view(), name="review_delete"),
]